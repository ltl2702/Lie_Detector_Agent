...
import { X, Brain, AlertTriangle, CheckCircle, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fadeIn">
      ...
      <div className="relative bg-gray-900 rounded-2xl shadow-2xl border-2 max-w-3xl w-full max-h-[85vh] overflow-hidden animate-slideIn">
        ...
        <div className={`bg-gradient-to-r ${getSuspicionColor()} p-6 border-b-2`}>
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-300 mt-1">Powered by Google Gemini</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="mt-4 flex items-center gap-3">
            ...
            <span className={`px-4 py-2 rounded-lg font-bold text-lg ${
              analysis.suspicion_level === 'HIGH' ? 'bg-red-600 text-white' :
              analysis.suspicion_level === 'MEDIUM' ? 'bg-yellow-600 text-white' :
              analysis.suspicion_level === 'LOW' ? 'bg-green-600 text-white' :
        ...
        <div className="overflow-y-auto max-h-[calc(85vh-180px)] p-6 space-y-4">
          ...
          {analysis.error && (
            <div className="bg-red-900 bg-opacity-30 border border-red-600 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-red-400 mb-2">⚠️ Lỗi phân tích</h3>
