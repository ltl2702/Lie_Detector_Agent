...
import { History, Play, Calendar, Clock, TrendingUp, ChevronRight } from 'lucide-react';
    ...
    <div className="bg-gray-800 rounded-lg p-6">
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 text-sm mt-2">Start a new session to see it here</p>
        </div>
      ) : (
                  ...
                  <div className="flex flex-wrap gap-4 text-sm text-gray-400">
                    ...
                    {session.calibration_end_time && (
                      <div className="flex items-center gap-1">
                        ...
                        <span>{formatDuration(session.start_time, session.calibration_end_time)}</span>
                      </div>
                    )}
