...
def main_menu():
    ...
    while running:
        ...
        if pygame.display.get_surface() is not None: # Check if surface exists
            ...
            # Buttons
            draw_button(screen, webcam_button, 'Start Webcam', font, webcam_button.collidepoint(mouse_pos))
